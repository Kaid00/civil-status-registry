...
const birthSchema = mongoose.Schema(
  {
    surname: {
      ...
      maxLength: [100, 'A surname must be less than or equal to 100'],
      trim: true,
    },
    givenname: {
      type: String,
      required: [true, 'Why no Given name'],
      maxLength: [100, 'A given name must be less than or equal to 100'],
      trim: true,
    },
    born_at: {
      type: String,
...
birthSchema.virtual('fullName').get(function () {
